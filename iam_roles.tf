###
### Load Balancer Controller Policy, Role and attachment
###
...
### Load Balancer Controller Policy, Role and attachment
###
resource "aws_iam_role" "LoadBalancerRole" {
...
resource "aws_iam_policy" "LoadBalancerPolicy" {
  ...
  description = "Load Balancer Policy for EKS created with Terraform"
...
resource "aws_iam_role_policy_attachment" "LoadBalancerPolicyAttachment" {
  role       = aws_iam_role.LoadBalancerRole.name
  policy_arn = aws_iam_policy.LoadBalancerPolicy.arn
}